  ...
  return (
    <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
      ...
      >
        ...
        <Image
          source={{
            uri: 'https://images.unsplash.com/photo-1519003722824-194d4455a60c?ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80'
          }}
          ...
          <View style={styles.card}>
            ...
            >
              <Text style={styles.loginLinkText}>
                Already on board? <Text style={styles.loginLinkHighlight}>Sign In</Text>
              </Text>
            </TouchableOpacity>
          </View>
        </Animated.View>
